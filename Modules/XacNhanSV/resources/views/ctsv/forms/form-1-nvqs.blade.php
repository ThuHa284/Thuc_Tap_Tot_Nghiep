...
@section('title', 'Đơn xin xác nhận hoãn nghĩa vụ quân sự')
...
<div class="container py-4" style="max-width:800px">
    ...
    <div class="card shadow" style="font-family:'Times New Roman',serif;font-size:14px;padding:40px 50px;background:#fff;border:1px solid #ccc">
        ...
        <p class="mb-1">
            ...
            &nbsp; Hệ đào tạo: <input type="text" class="border-0 border-bottom px-1"
                style="width:120px;outline:none;background:transparent" value="Chính quy" readonly>
            &nbsp; của Trường Đại học Công nghệ Sài Gòn.
        </p>

        <p class="mb-1">
            Số điện thoại liên lạc: <input type="text" name="sdt" class="border-0 border-bottom px-1"
                style="width:150px;outline:none;background:transparent" placeholder="Nhập số điện thoại">
        </p>
        ...
        <p class="mb-1">
            <label><input type="checkbox" name="xin_hoan_nvqs" value="1"> &nbsp; Xin hoãn nghĩa vụ quân sự</label>
        </p>

        <p class="mb-3">
            Lý do khác: <input type="text" name="ly_do_khac" class="border-0 border-bottom px-1"
                style="width:350px;outline:none;background:transparent" placeholder="Nhập lý do khác nếu có">
        </p>
        ...
        <div class="d-flex justify-content-between mt-2">
            <div style="width:50%">
                <p>Tp.Hồ Chí Minh, ngày
                    ...
                    tháng
                    <input type="text" name="thang_ky" class="border-0 border-bottom px-1" style="width:30px;outline:none;background:transparent">
                    năm
                    <input type="text" name="nam_ky" class="border-0 border-bottom px-1" style="width:50px;outline:none;background:transparent" value="{{ date('Y') }}">
                </p>
            </div>
