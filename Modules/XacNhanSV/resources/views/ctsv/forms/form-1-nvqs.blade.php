...
<div class="container py-4" style="max-width:800px">
    ...
    <div class="card shadow" style="font-family:'Times New Roman',serif;font-size:14px;padding:40px 50px;background:#fff;border:1px solid #ccc">
        ...
        <p class="mb-3">
            Lý do khác:
            <input type="text" name="ly_do_khac" class="border-0 border-bottom px-1"
                style="width:340px;outline:none;background:transparent"
    ...
    <div class="card mt-3 p-4">
        ...
        <div class="mb-3">
            ...
            <textarea name="note" class="form-control mt-1" rows="3"
                placeholder="Ghi chú nếu có..." maxlength="1000"></textarea>
        </div>
...
// Chỉ cho nhập số vào các ô number
