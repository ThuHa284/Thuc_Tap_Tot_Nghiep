...
<div class="container py-4" style="max-width:800px">
    ...
    <div class="card shadow" style="font-family:'Times New Roman',serif;font-size:14px;padding:40px 50px;background:#fff;border:1px solid #ccc">
        ...
        <p class="mb-1">
            Từ ngày:
            <input type="number" name="tu_ngay_d" class="border-0 border-bottom px-1"
                style="width:35px;outline:none;background:transparent"
                placeholder="dd" min="1" max="31" required oninput="this.value=this.value.replace(/[^0-9]/g,'')">
            /
            <input type="number" name="tu_ngay_m" class="border-0 border-bottom px-1"
                style="width:35px;outline:none;background:transparent"
                placeholder="mm" min="1" max="12" required oninput="this.value=this.value.replace(/[^0-9]/g,'')">
            /
            <input type="number" name="tu_ngay_y" class="border-0 border-bottom px-1"
                style="width:55px;outline:none;background:transparent"
                placeholder="yyyy" min="2000" max="{{ date('Y') }}" required oninput="this.value=this.value.replace(/[^0-9]/g,'')">
            &nbsp; đến ngày:
            <input type="number" name="den_ngay_d" class="border-0 border-bottom px-1"
                style="width:35px;outline:none;background:transparent"
                placeholder="dd" min="1" max="31" required oninput="this.value=this.value.replace(/[^0-9]/g,'')">
            /
            <input type="number" name="den_ngay_m" class="border-0 border-bottom px-1"
                style="width:35px;outline:none;background:transparent"
                placeholder="mm" min="1" max="12" required oninput="this.value=this.value.replace(/[^0-9]/g,'')">
            /
            <input type="number" name="den_ngay_y" class="border-0 border-bottom px-1"
                style="width:55px;outline:none;background:transparent"
                placeholder="yyyy" min="2000" max="2050" required oninput="this.value=this.value.replace(/[^0-9]/g,'')">
        </p>

        <p class="mb-2">Mục đích:</p>
        <div class="ms-3 mb-3">
            <label class="d-block mb-1"><input type="checkbox" name="muc_dich[]" value="xin_viec"> &nbsp; Xin việc làm</label>
            <label class="d-block mb-1"><input type="checkbox" name="muc_dich[]" value="hoc_bong"> &nbsp; Xét học bổng</label>
            <label class="d-block mb-1"><input type="checkbox" name="muc_dich[]" value="du_hoc"> &nbsp; Du học / Visa</label>
            <label class="d-block mb-1"><input type="checkbox" name="muc_dich[]" value="ho_so_khac"> &nbsp; Bổ túc hồ sơ khác</label>
            <div class="mt-1">
                Mục đích khác:
